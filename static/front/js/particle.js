(function(a) {
    ...
    b.prototype.init = function() {
        ...
        this.options.interactive && (this.p = new c(this), this.p.velocity = { x: 0, y: 0 }, this.o.push(this.p), this.canvas.addEventListener("mousemove", function(a) {
            ...
            this.p.velocity = { x: (Math.random() - 0.5) * this.options.velocity, y: (Math.random() - 0.5) * this.options.velocity };
            this.p = new c(this);
    ...
    b.prototype.j = function(a) {
        return "high" === a ? 5000 : "low" === a ? 20000 : isNaN(parseInt(a, 10)) ? 10000 : a;
    };
